  ...
  describe('POST', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/cooking/migrate-guest-data',
        {
          method: 'POST',
    ...
    it('should validate request body structure', async () => {
      ...
      // Test null guestData
      const nullRequest = new NextRequest(
        'http://localhost/api/cooking/migrate-guest-data',
        {
          method: 'POST',
      ...
      const stringRequest = new NextRequest(
        'http://localhost/api/cooking/migrate-guest-data',
        {
          method: 'POST',
      ...
      const invalidArrayRequest = new NextRequest(
        'http://localhost/api/cooking/migrate-guest-data',
        {
          method: 'POST',
      ...
      const emptyRequest = new NextRequest(
        'http://localhost/api/cooking/migrate-guest-data',
        {
          method: 'POST',
          body: JSON.stringify({}),
