...
describe('/api/cooking/foods', () => {
	...
	describe('DELETE', () => {
		it('should return 401 if not authenticated', async () => {
			...
			const request = new NextRequest('http://localhost/api/cooking/foods?id=food-id');
		...
		it('should delete food owned by user', async () => {
			...
			const request = new NextRequest('http://localhost/api/cooking/foods?id=food-to-delete');
			const response = await DELETE(request);
			const data = await response.json();
		...
		it('should return 404 if food not found', async () => {
			...
			const request = new NextRequest('http://localhost/api/cooking/foods?id=non-existent');
			const response = await DELETE(request);
			const data = await response.json();
