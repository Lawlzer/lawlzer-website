...
const DATA_PLATFORM_CARD_ID = 'data-platform-card';

function getProjects(hostname: string): ProjectItem[] {
	return [
		{
			id: 'website',
...
function handleProjectAction(project: ProjectItem, setSelectedId: (id: string) => void): void {
...
function ProjectCard({ project, setSelectedId }: { project: ProjectItem; setSelectedId: (id: string) => void }): JSX.Element {
	...
	return (
		<motion.div
			...
			onClick={
				project.isClickable
					? () => {
							handleProjectAction(project, setSelectedId);
						}
					: undefined
			}
			onKeyDown={
...
export default function MainPage(): JSX.Element {
	...
	const projects = getProjects(hostname);
	...
	return (
		<div className='flex w-full flex-grow flex-col'>
			...
			<AnimatePresence>
				{selectedId === DATA_PLATFORM_CARD_ID && (
					<DataPlatformPreview
						onClose={() => {
							setSelectedId(null);
						}}
