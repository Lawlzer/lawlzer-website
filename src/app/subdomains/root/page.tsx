			...
			<section>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
					...
					<div className='bg-secondary rounded-lg shadow-lg p-6 border border-border flex flex-col'>
						...
						/>
						<div className='flex-grow'>
							<h3 className='text-xl font-semibold mb-2 text-primary'>High-Performance Data Platform</h3>
							<p className='text-secondary-text text-sm mb-3'>Processed 2B+ documents with real-time dynamic search capabilities by integrating USDA APIs.</p>
							<h4 className='text-md font-medium mb-1 text-primary-text'>Key Features:</h4>
							<ul className='list-disc list-inside text-secondary-text text-sm space-y-1'>
								<li>Dynamic Mongoose DB for billions of docs</li>
