...
// Recipe empty state
export const RecipeEmptyState: React.FC<{ onCreateRecipe?: () => void }> = ({
  onCreateRecipe,
}) => (
  <BaseEmptyState
    icon={
...
// Food empty state
export const FoodEmptyState: React.FC<{ onScanFood?: () => void }> = ({
  onScanFood,
}) => (
  <BaseEmptyState
    icon={
...
// Goal empty state
export const GoalEmptyState: React.FC<{ onSetGoal?: () => void }> = ({
  onSetGoal,
}) => (
  <BaseEmptyState
    icon={
...
// Generic empty state
export const EmptyState: React.FC<BaseEmptyStateProps> = (props) => (
