...
describe('EmptyState', () => {
  it('renders with title and description', () => {
    render(
      <EmptyState title="Test Title" description="Test description text" />
    );
...
describe('NoSearchResultsEmptyState', () => {
  it('renders search term in description', () => {
    ...
    render(
      <NoSearchResultsEmptyState searchTerm="pizza" onClear={handleClear} />
    );

    expect(screen.getByText('No results found')).toBeInTheDocument();
    expect(
      screen.getByText('No items match "pizza". Try a different search term.')
    ).toBeInTheDocument();
...
describe('NoDataEmptyState', () => {
  it('renders default message', () => {
    ...
    expect(
      screen.getByText('Start by adding some items to see data here.')
    ).toBeInTheDocument();
  });
