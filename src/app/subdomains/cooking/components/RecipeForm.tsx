      ...
      <div>
        <label className="flex items-center gap-2">
          <input
            ...
            onChange={(e) => onInputChange('isComponent', e.target.checked)}
            className="rounded"
          />
      ...
      <div>
        ...
        <div className="space-y-3 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => onSelectedTypeChange('food')}
            ...
            <button
              type="button"
              onClick={() => onSelectedTypeChange('recipe')}
              className={`px-3 py-1 rounded ${
                selectedType === 'recipe'
                  ? 'bg-blue-500 text-white'
                  : 'bg-gray-200 dark:bg-gray-700'
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {selectedType === 'food' ? (
              <select
                ...
                onChange={(e) => onSelectedFoodIdChange(e.target.value)}
              ...
              <select
                ...
                onChange={(e) => onSelectedRecipeIdChange(e.target.value)}
                className="px-3 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700"
              >
