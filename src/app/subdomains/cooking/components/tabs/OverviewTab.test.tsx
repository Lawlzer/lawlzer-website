...
vi.mock('../Icons/index', () => ({
	CalendarIcon: ({ size: _size }: { size?: number }) => <div data-testid='calendar-icon'>CalendarIcon</div>,
	ChefHatIcon: ({ size: _size }: { size?: number }) => <div data-testid='chef-hat-icon'>ChefHatIcon</div>,
	UtensilsIcon: ({ size: _size }: { size?: number }) => <div data-testid='utensils-icon'>UtensilsIcon</div>,
}));
...
describe('OverviewTab', () => {
	...
	it('handles zero goals gracefully', () => {
		render(<OverviewTab {...defaultProps} dailyCalories={{ current: 500, goal: 0 }} dailyProtein={{ current: 50, goal: 0 }} />);
