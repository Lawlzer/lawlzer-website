		...
		<div className='container mx-auto p-4 space-y-6'>
			...
			<div className='p-4 border rounded-lg space-y-4'>
				...
				<div className='flex justify-between items-center'>
					...
					<button onClick={() => void handleSearch()} className='px-6 py-2 bg-primary text-primary-foreground rounded-lg' disabled={isLoading}>
			...
			<div>
				...
				{isLoading ? (
					...
					<VirtualizedRecipeList recipes={results} isOwner={false} onViewFullDay={(recipe) => setViewingFullDayRecipe(recipe)} />
				) : (
