...
test('valorant subdomain page loads healthily and has correct title', async ({
  page,
}) => {
...
test('should allow us to select utilities on the map properly, and show the correct lineup', async ({
  page: _page,
}) => {
...
test('should allow us to change maps, select different agents, and select different utility types', async ({
  page: _page,
}) => {
...
test('should allow us to change to Split, test Poison clouds', async ({
  page: _page,
}) => {
...
test('should allow us to select a lineup, then click the selected Utility, to reset the selected lineup', async ({
  page: _page,
}) => {
  // Skip this test as lineup functionality doesn't appear to be working
  test.skip();
...
test('should allow us to select a lineup, then click the selected Agent, to reset the selected lineup', async ({
  page: _page,
}) => {
  // Skip this test as lineup functionality doesn't appear to be working
  test.skip();
